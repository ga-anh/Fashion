...
function sanpham_update($name, $img, $price, $view, $bestseller, $iddm, $decrise,$idth, $id)
{
    if ($img != "") {
        $sql = "UPDATE sanpham SET name=?,img=?,price=?,view=?,bestseller=?,iddm=?,decrise=?,idth=? WHERE id=?";
        pdo_execute($sql, $name, $img, $price, $view, $bestseller, $iddm, $decrise,$idth, $id);
    } else {
        $sql = "UPDATE sanpham SET name=?,price=?,view=?,bestseller=?,iddm=?,decrise=?,idth=? WHERE id=?";
        pdo_execute($sql, $name, $price, $view, $bestseller, $iddm, $decrise,$idth, $id);
    }
}
        ...
        extract($sp);
            ...
            $html_dssp .= '<tr >
                            ...
                            <td>
                                ...
                                <a href="index.php?pg=delproduct&id=' . $id . '" class="btn btn-danger"><i class="fa-solid fa-folder-closed"></i> Xóa</a>                            
                            </td>
                        </tr>';
            $i++;
