...
if (isset($_GET['pg'])) {
    ...
    switch ($pg) {
        ...
        case 'sanphamupdate':
            ...
            //tro ve danh sach san pham
            $danhmuclist = danhmuc_select_all();
            $thuonghieulist = thuonghieu_select_all();
        ...
        case 'updateproduct':
            ...
            if (isset($_POST['updateproduct'])) {
                ...
                //insert into
                sanpham_update($name, $img, $price, $view, $bestseller, $iddm, $decrise,$idth, $id);
            }
            $sanphamlist = get_dssp_new(30);
            include "view/sanphamlist.php";
            break;
        ...
        case 'addvoucher':
            ...
            header('location: index.php?pg=voucher');
            break;
        case 'voucherupdate':
            if (isset($_GET['id']) && $_GET['id'] > 0) {
                $id = $_GET['id'];
