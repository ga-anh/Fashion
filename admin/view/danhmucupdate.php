...
<div class="main-content">
                ...
                <form class="addPro" action="index.php?pg=updatedanhmuc" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="id" value="<?php echo $id?>" placeholder="Nhập tên sản phẩm" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="stt" value="<?php echo $stt?>" placeholder="Nhập số thứ tự">
                    </div>
                    <div class="form-group">
